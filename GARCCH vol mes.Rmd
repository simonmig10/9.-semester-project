...
g_bar ~ vol_1*g_bar[-1] + (g_bar_var^0.5)*varepsilon,
g_bar_var ~ a_0 + a_1*g_bar_var[-1]*(varepsilon[-1]^2) + b_1*g_bar_var[-1], #Brugt ligning fra kilde
...
a_1 ~ 0.6,
b_1 ~0.3,
sd_ex ~ 1,#gør det muligt a lave stød il sd i exess return.
beta_mu ~ 3,
delta_mu ~ 0.1
  )
