...
Bruger GARCH til at lave volatilitet:

- vol=0 --> ingen volatilitet i modellen 
- eneste måde at lave stød på er vel ved at æændre standard deviation i Varepsilon, eller self æændre koefficienerne i GARCH modellen. 
...
- Ser ud til at når jeg laver det i P_e eksploderer andel variablene.
...
er_re ~ er_rbl + ex_e, ###lavet afkastet på aktier endogent. 
