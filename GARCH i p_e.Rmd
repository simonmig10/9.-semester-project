...
- Volatilitet er lavet i p_e funktion nu.
- Har forsøgt at bruge estimater for ARCH-M på månedlig c_20 i modellen
...
p_e ~ v_e*(lambda20 + lambda22*er_re + lambda23*er_rbl + lambda24*(yd_e/v_e) + lambda25* g_bar_var*vent_1)/e_s + vol*g_bar, 
...
vol ~ 0, #ligmed 1 når volatilitet skal med
vol_1 ~ 0.6,
...
```{r}
plot(sim2$g_bar, type="l",xlab="Year",
     ylab="Share",lty=1,lwd=2, col="black"); grid()
```

```{r}
plot(sim2$g_bar_var, type="l",xlab="Year",
     ylab="Share",lty=1,lwd=2, col="black");grid()
```
```{r}
plot(sim$mu_ex, type="l",xlab="Year",
     ylab="Share",lty=1,lwd=2, col="black");grid()
```
